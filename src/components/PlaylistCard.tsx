...
const PlaylistCard: React.FC<PlaylistProps> = ({ playlist, onPlaylistClick, selectedPlaylists }) => {
    return (
        <div
            key={playlist.id}
            className={`flex gap-4 cursor-pointer bg-[#242424] rounded-md p-3 border-2 ${
